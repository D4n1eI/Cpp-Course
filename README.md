...
| **The Standard Template Library(STL)**              | Introducing the Standard Template Library. Introductory lessons on Macro-Programming in C++ using templates then moving on to lectures on Containers(such as vectors, deques, lists, maps, sets etc), Iterators, some common data structures(such as stacks, queues, priority queues) and algorithms supported by the library and its extensions(foreach, transform, sort etc)|
